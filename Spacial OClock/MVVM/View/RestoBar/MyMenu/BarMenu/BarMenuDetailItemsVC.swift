...
class BarMenuDetailItemsVC: UIViewController {
    ...
    //MARK: Variables
    var arrModel : [ModelBarMenuDetailItem] = [ModelBarMenuDetailItem(img: "goose",
                                                                      itemName: "Grey Goose") ,
                                               ModelBarMenuDetailItem(img: "belveder", itemName:"Belvedere"),
                                               ModelBarMenuDetailItem(img: "Ciroc", itemName: "Ciroc") ,
                                             ]
    var heading = String()
...
extension BarMenuDetailItemsVC : UITableViewDelegate, UITableViewDataSource{
        func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
            return arrModel.count
        }
        
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = tableView.dequeueReusableCell(withIdentifier: Cell.CellBarDetailItemTV, for: indexPath) as! CellBarDetailItemTV
...
extension BarMenuDetailItemsVC{
